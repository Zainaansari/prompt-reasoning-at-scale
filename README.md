...
│   ├── gsm8k.json                          # 100 sampled GSM8K questions (seed=42)
│   └── commonsenseqa.json                  # 100 sampled CommonsenseQA questions (seed=42)
│
├── prompts/
...
│
├── results/
│   ├── csqa_gemma-2b_cot.csv               # Raw outputs and scores per run - CSQA
|   ├── csqa_gemma-2b_fewshot.csv
|   ├── csqa_gemma-2b_self_consistency.csv
|   ├── csqa_gemma-2b_standard.csv
│   ├── gsm8k_gemma-2b_cot.csv              # Raw outputs and scores per run - GSM8K
|   ├── gsm8k_gemma-2b_fewshot.csv
|   ├── gsm8k_gemma-2b_self_consistency.csv
|   ├── gsm8k_gemma-2b_standard.csv
│   ├── summary_table.csv                   # Aggregated accuracy table
│   ├── plot_consistency_rates.png          # Generated plots
|   ├── plot_csqa_accuracy.png
|   ├── plot_gsm8k_accuracy.png
│   └── summary_table.csv                   # Aggregated accuracy table
│
└── analysis/
    ├── result_validation.ipynb             # Validate results generated by each prompting strategies on GSM8K
...
```bash
git clone https://github.com/Zainaansari/prompt-reasoning-at-scale.git
